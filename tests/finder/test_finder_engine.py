...
class FinderEngineTest(unittest.TestCase):
    ...
    def test_run_with_regex_finder(self):
        ...
        target.notification_engine.run.assert_has_awaits([
            call(notifiers=['NOTIFIER.DISCORD.NOT_002'], entity=message_entity, rule_id='FINDER.RULE.UT_Finder_Demo', source='+15558987453'),
            call(notifiers=['NOTIFIER.DISCORD.NOT_002'], entity=message_entity, rule_id='FINDER.RULE.UT_Finder_Demo_MultiLine', source='+15558987453'),
            call(notifiers=['NOTIFIER.DISCORD.NOT_002'], entity=message_entity, rule_id='FINDER.RULE.UT_Finder_Demo_MultiLine_WithLineBreak', source='+15558987453'),
        ])
