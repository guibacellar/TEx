...
class TelegramGroupMessageListener(BaseModule):
    ...
    async def __handle_medias(self, message: Message, group_id: int, data_path: str) -> Optional[int]:
        ...
        executor_spec: Dict = {}
        if executor_id in TelegramMediaDatabaseManager.__MEDIA_HANDLERS:
            executor_spec = TelegramMediaDatabaseManager.__MEDIA_HANDLERS[executor_id]
        else:
            executor_spec = TelegramMediaDatabaseManager.__MEDIA_HANDLERS['application/vnd.generic.binary']
